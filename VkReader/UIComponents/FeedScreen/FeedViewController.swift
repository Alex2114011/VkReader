...
class FeedViewController: BaseController {
    ...
    func registerCells() {
        collectionView.register(UINib(nibName: String(describing: WallPostCollectionCell.self), bundle: nil), forCellWithReuseIdentifier: String(describing: WallPostCollectionCell.self))
        collectionView.register(UINib(nibName: String(describing: WallPostWithImageCollectionCell.self), bundle: nil), forCellWithReuseIdentifier: String(describing: WallPostWithImageCollectionCell.self))
    }
